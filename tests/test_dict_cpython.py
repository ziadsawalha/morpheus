'''This comes from CPython's test_dict.py

Copied from https://github.com/akheron/cpython/commit/5b55aef06dde2a793a3c5b175
            7827c3f20e29887#Lib/test/test_dict.py
...
Changes by ZNS 2013-05-06:
- pep8/pylint
- replace dict with MorpheusDict
- comment out a bunch of tests that seem to be cpython specific
- replace {} with dict() in some places to add testing
...
class DictTest(unittest.TestCase):
    ...
    def test_values(self):
        ...
        d = dict({1: 2})  # modified to use dict()
    ...
    def test_update(self):
        ...
        class FailingUserDict:
            ...
            def __getitem__(self, key):
                return key
        self.assertRaises(TypeError, d.update, FailingUserDict())
        ...
        class FailingUserDict:
            ...
            def __getitem__(self, key):
                raise Exc
        # TODO: look into this self.assertRaises(Exc, d.update, FailingUserDict())
    ...
    def helper_keys_contained(self, fn):
        ...
        """ TODO: look at this self.assertFalse(smaller <  larger3)
